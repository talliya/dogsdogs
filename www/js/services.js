...
.factory('fireBaseData', function($firebase) {
    ...
    refCart = new Firebase("https://dogmeet-9bccf.firebaseio.com/cart"),
    refUser = new Firebase("https://dogmeet-9bccf.firebaseio.com/users"),
    //refCategory = new Firebase("https://dogmeet-9bccf.firebaseio.com/category"),
    refOrder = new Firebase("https://dogmeet-9bccf.firebaseio.com/orders"),
    refFeatured = new Firebase("https://dogmeet-9bccf.firebaseio.com/featured"),
    ...
    cart.increment=function(item_id){
      ...
      fireBaseData.refCart().child(uid).once("value", function(snapshot) {
        if( snapshot.hasChild(item_id) == true ){
          ...
          var currentQty = snapshot.child(item_id).val().item_qty || 0;
